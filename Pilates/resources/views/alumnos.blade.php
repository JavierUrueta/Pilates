                    ...
                    <tbody>
                            @foreach($alumnos as $alumno)
                                <tr>
                                    ...
                                    <td>                                 
                                        <button data-id="{{$alumno->id}}" data-nombre="{{$alumno->nombre}}" data-cumpleaños="{{$alumno->cumpleaños}}" data-telefono="{{$alumno->telefono}}" data-padecimiento="{{$alumno->padecimiento}}" type="button" class="btn btn-warning" value="Editar" data-bs-toggle="modal" data-bs-target="#staticBackdrop">Editar</button>
                                    </td>
                                    <td>
                                        <form action="/eliminar" method="POST"><!--ELIMINAR-->
                                            @csrf 
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <form action="/almacenar" method="post"> <!--CUERPO Y PIE DEL MOODAL DE EDICION-->
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="input-group input-group-sm mb-3">
                                                        <span class="input-group-text" id="inputGroup-sizing-sm">Cumpleaños</span>
                                                        <input  id="cumpleaños" name="cumpleaños" type="date" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm">
                                                    </div>
                                                    <div class="input-group input-group-sm mb-3">
                                                        <span class="input-group-text" id="inputGroup-sizing-sm">Teléfono</span>
                                                    ...
                                                    <div class="input-group input-group-sm mb-3">
                                                        <span class="input-group-text" id="inputGroup-sizing-sm">Padecimiento(s)</span>
                                                        <input id="padecimiento" name="padecimiento" type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm">
                                                    </div>
                                                </div>
                                                <div class="modal-footer">
